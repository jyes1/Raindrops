class Raindrop {
  ...
  float d; //declares d, which will be diameter of raindrop

  Raindrop() {
    d=10; //the diameter of the raindrop
    l = new PVector(random(15, 485), random(-15, 0)); //creates location for each raindrop to begin. it look more realistic since they don't all fall from same point
